...
export function Hero() {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full">
      <section className="min-h-screen flex flex-col justify-center relative px-4 sm:px-6 lg:px-8 overflow-hidden flex-[7]">
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          >
            <h1 className="text-6xl sm:text-7xl font-bold mb-6 tracking-tight">
              Hello, I'm <span className="text-blue-700">Harish</span>
            </h1>
          </motion.div>
          ...
          >
            {[
              ...
              {
                icon: Linkedin,
                href: "www.linkedin.com/in/harishbhupeshthampi",
              },
              { icon: Mail, href: "#" },
            ].map((item, index) => (
              <motion.a
      ...
      <section className="min-h-screen flex flex-col justify-center relative px-4 sm:px-6 lg:px-8 overflow-hidden flex-[3]">
               <motion.div
