...
import hjp from '../Assets/jobPortal.jpeg';
...
const projects = [
  ...
  },
  {
    ...
    image: hjp,
    longDescription: 'A Netflix clone built with React and Redux, featuring dynamic content rendering, robust state management, and a responsive UI for a seamless streaming experience. The platform mimics the Netflix interface, allowing users to browse, search, and view movie details, all within a modern, user-friendly design.',
  ...
  },
  {
    ...
    image: klimate,
    longDescription: 'Klimate is a weather application built with React and TypeScript, utilizing the OpenWeatherMap API to provide real-time weather data and location-based forecasts. The app features a modern UI with Shadcn UI and TailwindCSS, and leverages Tanstack for efficient data fetching and state management.',
